...
function bright_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'bright' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'bright_custom_background_args', array(
 ...
 */
function bright_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'bright_content_width', 640 );
}
add_action( 'after_setup_theme', 'bright_content_width', 0 );
...
function bright_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'bright' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
function bright_scripts() {
	...
	wp_enqueue_script( 'bright-app', get_template_directory_uri() . '/js/app.js', array(), '20151215', true );

	wp_enqueue_script( 'bright-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );

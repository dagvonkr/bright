...
<!--  <a class="cart-contents" href="<?php echo wc_get_cart_url(); ?>" title="<?php _e( 'View your shopping cart' ); ?>"><?php echo sprintf ( _n( '%d item', '%d items', WC()->cart->get_cart_contents_count() ), WC()->cart->get_cart_contents_count() ); ?> - <?php echo WC()->cart->get_cart_total(); ?></a> -->
    ...
    <!-- PRODUCTS -->
      ...
      <div class="product-wrapper-inner">
        ...
        <div id="post-<?php the_ID(); ?>" <?php post_class($extra_class) ?> >
          ...
          <div <?php post_class($extra_class_readmore) ?> >
  ...
  <div id="content<?php echo ($c); ?>" style="display: none" class="collapse-container" data-expanded="false">
          ...
          <!-- Leaving out  max-width-container here -->
    <div class="top-image-wrapper">
          ...
          <div class="technical-specs">
            ...
            <div id="content<?php echo ($c_technical_specification); ?>" style="display: none" class="collapse-container" data-expanded="false">
              <div class="collapse-wrapper-inner">
                  <div class="technical-specs-inner"></div>
                    <?php
...
<!--         <div class="quantity">
            <input type="number" step="1" min="1" max="9" name="quantity" value="1" title="<?php _e('Szt.', 'bright'); ?>" class="input-text qty text" size="4">
        </div>
        <div class="color">
          <select id="colors" name="attribute_colors" data-attribute_name="attribute_colors">
        ...
        <input type="hidden" name="add-to-cart" value="<?php echo esc_attr($product->id); ?>"> -->
         <!-- <button class="ajax_add_to_cart" type="submit"><?php echo $product->single_add_to_cart_text(); ?></button> -->
